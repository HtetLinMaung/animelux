...
export default function Popular({ items, pages, p }) {
  return (
    <div className="container mx-auto px-4 pt-10">
      <h1 className="text-4xl my-7 text-center sm:text-left">Popular</h1>
      ...
      >
        <ul className="my-7 inline-flex bg-white rounded-2xl p-2 px-3 shadow-lg">
          {pages.map((page, i) => (
            <Link key={i} href={`/animelux/popular/page/${page}`} passHref>
              <li
